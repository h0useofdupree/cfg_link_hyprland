...
bg_default = "#e2e4e5"  # Main background (light gray)
bg_lighter = "#d3d6d8"  # Lighter than main background
bg_selection = "#bfc2c5"  # Background for selections
fg_disabled = "#a0a4a8"  # Disabled text color
fg_default = "#40474d"  # Primary text color (dark gray)
bg_lightest = "#f1f2f3"  # Lightest background, for toolbars or panels
fg_error = "#e57373"  # Error color (soft red)
bg_hint = "#f9db9e"  # Hint or warning background (light yellow)
fg_matched_text = "#4F7CA4"  # Matched text color (soft green)
bg_passthrough_mode = "#88d8d8"  # Passthrough mode color (light teal)
bg_insert_mode = "#a0c4ef"  # Insert mode color (soft blue)
bg_warning = "#d7a9e3"  # Warning color (soft purple)
# "#be5046"                     # dark red
