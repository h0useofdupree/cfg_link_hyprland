...
bg_default = "#1f2224"  # Main background (light gray)
bg_lighter = "#222729"  # Lighter than main background
bg_selection = "#121414"  # Background for selections
fg_disabled = "#565c64"  # Disabled text color
fg_default = "#abb2bf"  # Primary text color (dark gray)
bg_lightest = "#c8ccd4"  # Lightest background, for toolbars or panels
fg_error = "#e06c75"  # Error color (soft red)
bg_hint = "#e5c07b"  # Hint or warning background (light yellow)
fg_matched_text = "#98c379"  # Matched text color (soft green)
bg_passthrough_mode = "#56b6c2"  # Passthrough mode color (light teal)
bg_insert_mode = "#61afef"  # Insert mode color (soft blue)
bg_warning = "#c678dd"  # Warning color (soft purple)
# "#be5046"                     # dark red
